		...
		<div className="container">
			...
			{user ? (
				<div className="card p-5 mt-5" style={{ backgroundColor: "whitesmoke" }}>
					<h4 className="card-title text-center text-info">User Information</h4>
					<div className="card-body">
						<div className="col-md-15 mx-auto">
									...
									<div className="col-md-10">
										<div className="card-body" style={{color:'black'}}>
											<div className="form-group row">
												...
												<div className="col-md-10">
													<p className="card-text text-success">{user.id}</p>
												</div>
											</div>
											<hr />
											...
											<div className="form-group row">
												...
												<div className="col-md-10">
													<p className="card-text text-success">{user.firstName}</p>
												</div>
											</div>
											<hr />
											...
											<div className="form-group row">
												...
												<div className="col-md-10">
													<p className="card-text text-success">{user.lastName}</p>
												</div>
											</div>
											<hr />
											...
											<div className="form-group row">
												...
												<div className="col-md-10">
													<p className="card-text text-success">{user.email}</p>
												</div>
											</div>
											<hr />
							...
							<h4 className="card-title text-center text-info">Booking History</h4>
